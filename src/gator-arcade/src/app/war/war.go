...
func (g *game) HandleTie() int {
	...
	// 			if !g.p2.hand.Empty() {
	// 				for p := 0; p < i; p++ {
	// 					g.p2.newHand.Push(pot1[p])
	// 					g.p2.newHand.Push(pot2[p])
	// 					g.p2.numCards += 2
	// 				}
	// 				return 2
	// 			} else if !g.p2.newHand.Empty() {
	// 				g.p2.hand = g.p2.newHand
	// 				g.p2.newHand = *arraystack.New()
	// 				for p := 0; p < i; p++ {
	// 					g.p2.newHand.Push(pot1[p])
	...
	// 				return 2
	// 			} else {
	// 				g.p1.hand.Push(pot1[i])
	// 				g.p2.hand.Push(pot2[i])
	// 				break
	// 			}
	// 		} else {
	// 			g.p1.hand.Pop()
	...
	// 		if !b2 {
	// 			for p := 0; p < i; p++ {
	// 				g.p1.newHand.Push(pot1[p])
	// 				g.p1.newHand.Push(pot2[p])
	// 				g.p1.numCards += 2
	// 			}
	// 			return 1
	// 		} else {
